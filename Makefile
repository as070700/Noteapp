#############################################################################
# Makefile for building: NoteApp.app/Contents/MacOS/NoteApp
# Generated by qmake (3.1) (Qt 6.8.2)
# Project:  NoteApp.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile NoteApp.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = NoteApp1.0.0
DISTDIR = /Users/angy/GitHub_Link/Noteapp/.tmp/NoteApp1.0.0
...
SOURCES       = main.cpp \
		...
		moc_deletenote.cpp \
		moc_detaileditnote.cpp \
		moc_detailshownote.cpp \
		moc_editnote.cpp \
		moc_newnote.cpp \
		moc_searchnote.cpp \
		moc_securityquestiondialog.cpp \
		moc_setpassworddialog.cpp \
		moc_shownote.cpp \
		moc_getpassworddialog.cpp
OBJECTS       = main.o \
		deletenote.o \
		detaileditnote.o \
		detailshownote.o \
		...
		moc_mainwindow.o \
		moc_deletenote.o \
		moc_detaileditnote.o \
		moc_detailshownote.o \
		moc_editnote.o \
		moc_newnote.o \
		moc_searchnote.o \
		moc_securityquestiondialog.o \
		moc_setpassworddialog.o \
		moc_shownote.o \
		moc_getpassworddialog.o
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		getpassworddialog.cpp \
		utils.cpp
QMAKE_TARGET  = NoteApp
DESTDIR       = 
TARGET        = NoteApp.app/Contents/MacOS/NoteApp

####### Custom Variables
EXPORT_QMAKE_MAC_SDK = macosx
EXPORT_QMAKE_MAC_SDK_VERSION = 15.2
EXPORT_QMAKE_XCODE_DEVELOPER_PATH = /Applications/Xcode.app/Contents/Developer
EXPORT__QMAKE_STASH_ = /Users/angy/GitHub_Link/Noteapp/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/angy/GitHub_Link/Noteapp/NoteApp.pro
...
NoteApp.app/Contents/MacOS/NoteApp: ui_mainwindow.h ui_deletenote.h ui_detaileditnote.h ui_detailshownote.h ui_editnote.h ui_newnote.h ui_searchnote.h ui_securityquestiondialog.h ui_setpassworddialog.h ui_shownote.h ui_getpassworddialog.h $(OBJECTS)  
	@test -d NoteApp.app/Contents/MacOS/ || mkdir -p NoteApp.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: NoteApp.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.8.2/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.8.2/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.8.2/share/qt/mkspecs/common/macx.conf \
...
NoteApp.app/Contents/PkgInfo: 
	@test -d NoteApp.app/Contents || mkdir -p NoteApp.app/Contents
	@$(DEL_FILE) NoteApp.app/Contents/PkgInfo
	@echo "APPL????" > NoteApp.app/Contents/PkgInfo
NoteApp.app/Contents/Info.plist: 
	@test -d NoteApp.app/Contents || mkdir -p NoteApp.app/Contents
	@$(DEL_FILE) NoteApp.app/Contents/Info.plist
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,Angelika.NoteApp,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},Angelika.NoteApp,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,NoteApp,g" -e "s,@LIBRARY@,NoteApp,g" -e "s,\$${EXECUTABLE_NAME},NoteApp,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >NoteApp.app/Contents/Info.plist

all: Makefile \
		NoteApp.app/Contents/PkgInfo \
		NoteApp.app/Contents/Info.plist NoteApp.app/Contents/MacOS/NoteApp
...
distdir: FORCE
	...
	$(COPY_FILE) --parents mainwindow.h deletenote.h detaileditnote.h detailshownote.h editnote.h newnote.h notebook.h note.h searchnote.h securityquestiondialog.h setpassworddialog.h shownote.h getpassworddialog.h utils.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp deletenote.cpp detaileditnote.cpp detailshownote.cpp editnote.cpp mainwindow.cpp newnote.cpp notebook.cpp searchnote.cpp securityquestiondialog.cpp setpassworddialog.cpp shownote.cpp getpassworddialog.cpp utils.cpp $(DISTDIR)/
	$(COPY_FILE) --parents mainwindow.ui deletenote.ui detaileditnote.ui detailshownote.ui editnote.ui newnote.ui searchnote.ui securityquestiondialog.ui setpassworddialog.ui shownote.ui getpassworddialog.ui $(DISTDIR)/
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_deletenote.cpp moc_detaileditnote.cpp moc_detailshownote.cpp moc_editnote.cpp moc_newnote.cpp moc_searchnote.cpp moc_securityquestiondialog.cpp moc_setpassworddialog.cpp moc_shownote.cpp moc_getpassworddialog.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_deletenote.cpp moc_detaileditnote.cpp moc_detailshownote.cpp moc_editnote.cpp moc_newnote.cpp moc_searchnote.cpp moc_securityquestiondialog.cpp moc_setpassworddialog.cpp moc_shownote.cpp moc_getpassworddialog.cpp
...
moc_deletenote.cpp: deletenote.h \
		...
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/angy/GitHub_Link/Noteapp/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/angy/GitHub_Link/Noteapp -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/16/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk/usr/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -F/opt/homebrew/lib deletenote.h -o moc_deletenote.cpp

moc_detaileditnote.cpp: detaileditnote.h \
		...
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/angy/GitHub_Link/Noteapp/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/angy/GitHub_Link/Noteapp -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/16/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk/usr/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -F/opt/homebrew/lib detaileditnote.h -o moc_detaileditnote.cpp

moc_detailshownote.cpp: detailshownote.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QDialog \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qdialog.h \
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/angy/GitHub_Link/Noteapp/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/angy/GitHub_Link/Noteapp -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/16/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk/usr/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -F/opt/homebrew/lib detailshownote.h -o moc_detailshownote.cpp

moc_editnote.cpp: editnote.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QWidget \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qwidget.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QListWidgetItem \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qlistwidget.h \
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/angy/GitHub_Link/Noteapp/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/angy/GitHub_Link/Noteapp -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/16/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk/usr/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -F/opt/homebrew/lib editnote.h -o moc_editnote.cpp

moc_newnote.cpp: newnote.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QDialog \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qdialog.h \
		/opt/homebrew/lib/QtGui.framework/Headers/QTextCharFormat \
		/opt/homebrew/lib/QtGui.framework/Headers/qtextformat.h \
		...
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/angy/GitHub_Link/Noteapp/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/angy/GitHub_Link/Noteapp -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/16/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk/usr/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -F/opt/homebrew/lib newnote.h -o moc_newnote.cpp

moc_searchnote.cpp: searchnote.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QWidget \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qwidget.h \
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/angy/GitHub_Link/Noteapp/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/angy/GitHub_Link/Noteapp -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/16/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk/usr/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -F/opt/homebrew/lib searchnote.h -o moc_searchnote.cpp

moc_securityquestiondialog.cpp: securityquestiondialog.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QDialog \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qdialog.h \
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/angy/GitHub_Link/Noteapp/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/angy/GitHub_Link/Noteapp -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/16/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk/usr/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -F/opt/homebrew/lib securityquestiondialog.h -o moc_securityquestiondialog.cpp

moc_setpassworddialog.cpp: setpassworddialog.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QDialog \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qdialog.h \
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/angy/GitHub_Link/Noteapp/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/angy/GitHub_Link/Noteapp -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/16/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk/usr/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -F/opt/homebrew/lib setpassworddialog.h -o moc_setpassworddialog.cpp

moc_shownote.cpp: shownote.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QWidget \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qwidget.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QListWidgetItem \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qlistwidget.h \
		...
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/angy/GitHub_Link/Noteapp/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/angy/GitHub_Link/Noteapp -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/16/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk/usr/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -F/opt/homebrew/lib shownote.h -o moc_shownote.cpp

moc_getpassworddialog.cpp: getpassworddialog.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QDialog \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qdialog.h \
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/angy/GitHub_Link/Noteapp/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/angy/GitHub_Link/Noteapp -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/16/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk/usr/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -F/opt/homebrew/lib getpassworddialog.h -o moc_getpassworddialog.cpp

compiler_moc_objc_header_make_all:
compiler_moc_objc_header_clean:
compiler_moc_source_make_all:
compiler_moc_source_clean:
compiler_uic_make_all: ui_mainwindow.h ui_deletenote.h ui_detaileditnote.h ui_detailshownote.h ui_editnote.h ui_newnote.h ui_searchnote.h ui_securityquestiondialog.h ui_setpassworddialog.h ui_shownote.h ui_getpassworddialog.h
compiler_uic_clean:
	-$(DEL_FILE) ui_mainwindow.h ui_deletenote.h ui_detaileditnote.h ui_detailshownote.h ui_editnote.h ui_newnote.h ui_searchnote.h ui_securityquestiondialog.h ui_setpassworddialog.h ui_shownote.h ui_getpassworddialog.h
ui_mainwindow.h: mainwindow.ui \
		/opt/homebrew/share/qt/libexec/uic
	/opt/homebrew/share/qt/libexec/uic mainwindow.ui -o ui_mainwindow.h

ui_deletenote.h: deletenote.ui \
		/opt/homebrew/share/qt/libexec/uic
	/opt/homebrew/share/qt/libexec/uic deletenote.ui -o ui_deletenote.h

ui_detaileditnote.h: detaileditnote.ui \
		/opt/homebrew/share/qt/libexec/uic
	/opt/homebrew/share/qt/libexec/uic detaileditnote.ui -o ui_detaileditnote.h

ui_detailshownote.h: detailshownote.ui \
		/opt/homebrew/share/qt/libexec/uic
	/opt/homebrew/share/qt/libexec/uic detailshownote.ui -o ui_detailshownote.h

ui_editnote.h: editnote.ui \
		/opt/homebrew/share/qt/libexec/uic
	/opt/homebrew/share/qt/libexec/uic editnote.ui -o ui_editnote.h

ui_newnote.h: newnote.ui \
		/opt/homebrew/share/qt/libexec/uic
	/opt/homebrew/share/qt/libexec/uic newnote.ui -o ui_newnote.h

ui_searchnote.h: searchnote.ui \
		/opt/homebrew/share/qt/libexec/uic
	/opt/homebrew/share/qt/libexec/uic searchnote.ui -o ui_searchnote.h

ui_securityquestiondialog.h: securityquestiondialog.ui \
		/opt/homebrew/share/qt/libexec/uic
	/opt/homebrew/share/qt/libexec/uic securityquestiondialog.ui -o ui_securityquestiondialog.h

ui_setpassworddialog.h: setpassworddialog.ui \
		/opt/homebrew/share/qt/libexec/uic
	/opt/homebrew/share/qt/libexec/uic setpassworddialog.ui -o ui_setpassworddialog.h

ui_shownote.h: shownote.ui \
		/opt/homebrew/share/qt/libexec/uic
	/opt/homebrew/share/qt/libexec/uic shownote.ui -o ui_shownote.h

ui_getpassworddialog.h: getpassworddialog.ui \
		/opt/homebrew/share/qt/libexec/uic
	/opt/homebrew/share/qt/libexec/uic getpassworddialog.ui -o ui_getpassworddialog.h
...
main.o: main.cpp setpassworddialog.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QDialog \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qdialog.h \
		newnote.h \
		/opt/homebrew/lib/QtGui.framework/Headers/QTextCharFormat \
...
deletenote.o: deletenote.cpp deletenote.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QWidget \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qwidget.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QListWidgetItem \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qlistwidget.h \
		...
		/opt/homebrew/lib/QtCore.framework/Headers/QDebug \
		/opt/homebrew/lib/QtCore.framework/Headers/qdebug.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o deletenote.o deletenote.cpp

detaileditnote.o: detaileditnote.cpp detaileditnote.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QDialog \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qdialog.h \
		/opt/homebrew/lib/QtGui.framework/Headers/QTextCharFormat \
		/opt/homebrew/lib/QtGui.framework/Headers/qtextformat.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o detaileditnote.o detaileditnote.cpp

detailshownote.o: detailshownote.cpp detailshownote.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QDialog \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qdialog.h \
		getpassworddialog.h \
		ui_detailshownote.h \
		...
		/opt/homebrew/lib/QtCore.framework/Headers/QTextStream \
		/opt/homebrew/lib/QtCore.framework/Headers/qtextstream.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o detailshownote.o detailshownote.cpp

editnote.o: editnote.cpp editnote.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QWidget \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qwidget.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QListWidgetItem \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qlistwidget.h \
		...
		/opt/homebrew/lib/QtCore.framework/Headers/QDebug \
		/opt/homebrew/lib/QtCore.framework/Headers/qdebug.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o editnote.o editnote.cpp
...
newnote.o: newnote.cpp newnote.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QDialog \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qdialog.h \
		/opt/homebrew/lib/QtGui.framework/Headers/QTextCharFormat \
		/opt/homebrew/lib/QtGui.framework/Headers/qtextformat.h \
		...
		/opt/homebrew/lib/QtCore.framework/Headers/QStandardPaths \
		/opt/homebrew/lib/QtCore.framework/Headers/qstandardpaths.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o newnote.o newnote.cpp

notebook.o: notebook.cpp notebook.h \
		note.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o notebook.o notebook.cpp

searchnote.o: searchnote.cpp searchnote.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QWidget \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qwidget.h \
		shownote.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QListWidgetItem \
		...
		/opt/homebrew/lib/QtCore.framework/Headers/QDebug \
		/opt/homebrew/lib/QtCore.framework/Headers/qdebug.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o searchnote.o searchnote.cpp

securityquestiondialog.o: securityquestiondialog.cpp securityquestiondialog.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QDialog \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qdialog.h \
		ui_securityquestiondialog.h \
		utils.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QString \
		/opt/homebrew/lib/QtCore.framework/Headers/qstring.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QMessageBox \
		...
		/opt/homebrew/lib/QtCore.framework/Headers/QStandardPaths \
		/opt/homebrew/lib/QtCore.framework/Headers/qstandardpaths.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o securityquestiondialog.o securityquestiondialog.cpp

setpassworddialog.o: setpassworddialog.cpp setpassworddialog.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QDialog \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qdialog.h \
		...
		/opt/homebrew/lib/QtCore.framework/Headers/QStandardPaths \
		/opt/homebrew/lib/QtCore.framework/Headers/qstandardpaths.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o setpassworddialog.o setpassworddialog.cpp

shownote.o: shownote.cpp shownote.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QWidget \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qwidget.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QListWidgetItem \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qlistwidget.h \
		...
		/opt/homebrew/lib/QtCore.framework/Headers/QDebug \
		/opt/homebrew/lib/QtCore.framework/Headers/qdebug.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o shownote.o shownote.cpp

getpassworddialog.o: getpassworddialog.cpp getpassworddialog.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QDialog \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qdialog.h \
		ui_getpassworddialog.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QSettings \
		/opt/homebrew/lib/QtCore.framework/Headers/qsettings.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QStandardPaths \
		/opt/homebrew/lib/QtCore.framework/Headers/qstandardpaths.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QMessageBox \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qmessagebox.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o getpassworddialog.o getpassworddialog.cpp
...
moc_deletenote.o: moc_deletenote.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_deletenote.o moc_deletenote.cpp

moc_detaileditnote.o: moc_detaileditnote.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_detaileditnote.o moc_detaileditnote.cpp

moc_detailshownote.o: moc_detailshownote.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_detailshownote.o moc_detailshownote.cpp

moc_editnote.o: moc_editnote.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_editnote.o moc_editnote.cpp

moc_newnote.o: moc_newnote.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_newnote.o moc_newnote.cpp

moc_searchnote.o: moc_searchnote.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_searchnote.o moc_searchnote.cpp

moc_securityquestiondialog.o: moc_securityquestiondialog.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_securityquestiondialog.o moc_securityquestiondialog.cpp
...
moc_shownote.o: moc_shownote.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_shownote.o moc_shownote.cpp

moc_getpassworddialog.o: moc_getpassworddialog.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_getpassworddialog.o moc_getpassworddialog.cpp
